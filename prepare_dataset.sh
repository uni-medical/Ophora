...
MODEL_ID="/path/Ophora"

NUM_GPUS=1

# For more details on the expected data format, please refer to the README.
DATA_ROOT="/path/videos"  # This needs to be the path to the base directory where your videos are located.
CAPTION_COLUMN="/path/training_data/instructions.txt"
VIDEO_COLUMN="/path/training_data/videos.txt"
